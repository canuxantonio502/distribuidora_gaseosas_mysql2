...
VALUES
('Carlos', 'García', '1002938475', 'Zona 1, Ciudad', '55512345',
'carlos.garcia@email.com'),
('Ana', 'Martínez', '2938475610', 'Zona 4, Ciudad', '55523456',
'ana.martinez@email.com'),
('Luis', 'López', '3847561029', 'Zona 10, Ciudad', '55534567',
'luis.lopez@email.com'),
('María', 'González', '4756102938', 'Zona 14, Ciudad', '55545678',
'maria.gonzalez@email.com'),
('Jorge', 'Pérez', '5610293847', 'Zona 15, Ciudad', '55556789',
'jorge.perez@email.com'),
('Carmen', 'Ramírez', '6102938475', 'Zona 9, Ciudad', '55567890',
'carmen.ramirez@email.com'),
('Pedro', 'Hernández', '1029384756', 'Zona 5, Ciudad', '55578901',
'pedro.hernandez@email.com'),
('Lucía', 'Gómez', '9384756102', 'Zona 11, Ciudad', '55589012',
'lucia.gomez@email.com'),
('Miguel', 'Díaz', '8475610293', 'Zona 7, Ciudad', '55590123',
'miguel.diaz@email.com'),
('Sofía', 'Vásquez', '7561029384', 'Zona 13, Ciudad', '55501234',
'sofia.vasquez@email.com'),
('Diego', 'Castillo', '6453728190', 'Zona 16, Ciudad', '55513456',
'diego.castillo@email.com'),
('Laura', 'Morales', '5342617089', 'Zona 2, Ciudad', '55524567',
'laura.morales@email.com'),
('Andrés', 'Reyes', '4231506978', 'Zona 3, Ciudad', '55535678',
'andres.reyes@email.com'),
('Elena', 'Cruz', '3120495867', 'Zona 12, Ciudad', '55546789',
'elena.cruz@email.com'),
('Fernando', 'Ortiz', '2019384756', 'Zona 21, Ciudad', '55557890',
'fernando.ortiz@email.com');

INSERT INTO categorias (nombre, volumen) VALUES
('Gaseosas', '355 ml'),
...
INSERT INTO encargados (nombre, identificacion) VALUES
('Josué Ambrosi', '2345678900101'),
...
INSERT INTO sedes (nombre_sede, ubicacion, id_encargado) VALUES
('Sucursal Majadas', 'Fórum Majadas, Zona 11', 1),
...
INSERT INTO stocks (id_sede, id_producto, stock_actual, stock_minimo,
capacidad_almacenamiento) VALUES
(1, 10, 150, 50, 500),
(2, 4, 80, 20, 200),
(3, 8, 300, 100, 1000),
(4, 13, 60, 15, 150),
...
VALUES
(1, 1, 13.00, 14.56, '2026-08-01 10:30:00'),
